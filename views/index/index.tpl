...
<section id="featured">
	...
	<!-- Slider -->
        <div id="main-slider" class="flexslider">
            <ul class="slides">
              <li>
                <img src="{$_layoutParams.root}public/img/slides/1.png" alt="" />
              ...
              <li>
                <img src="http://via.placeholder.com/1024x360" alt="" />
                <div class="flex-caption">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                    <div class="big-cta">
                            <div class="cta-text">
                                <h2><span>Ismael Perez Pasmi&ntilde;o</span> Feria tecnol&oacute;gica </h2>
                            </div>
                    </div>
            </div>
        </div>
